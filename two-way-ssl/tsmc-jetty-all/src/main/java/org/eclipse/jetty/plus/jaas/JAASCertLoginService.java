...
import com.tsmc.security.callback.CertificateCallback;
 ...
 */
public class JAASCertLoginService extends AbstractLifeCycle implements LoginService
{
     ...
     */
    public JAASCertLoginService(String name)
    {
        this();
        _realmName = name;
                ...
                callbackHandler = new CallbackHandler()
                {
                    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException
                    {
                        for (Callback callback: callbacks)
                        {
                            ...
                            //else if (callback.getClass().getName().equals(CertificateCallback.class.getName()))
                            else if (callback instanceof CertificateCallback)
                            {
                                ((CertificateCallback)callback).addCertificate((Certificate) credentials);
                            }
