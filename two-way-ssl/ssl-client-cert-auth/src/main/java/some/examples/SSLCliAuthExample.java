...
public class SSLCliAuthExample {
	...
	private static final String CLIENT_KEYSTORE_PATH = "./certs/jetty.keystore";
	private static final String CLIENT_KEYSTORE_PASS = "karafkaraf";
	...
	public final static void requestTimestamp() throws Exception {
		...
		try (CloseableHttpClient httpclient = HttpClients.custom().setSSLSocketFactory(csf).build()) {
			...
			HttpPost req = new HttpPost("https://localhost:8543/two-way-ssl/karafWAB");
	...
	public static RequestConfig configureRequest() {
		...
		HttpHost proxy = new HttpHost("localhost", 8181, "http");
